...
export default function Home() {
  return (
    <div className="bg-black min-w-screen min-h-screen align-center items-center flex flex-col relative">
      ...
      <div className="content min-w-[60vw] min-h-[60vh] bg-[#00000000] text-black z-10 grid grid-rows-[1.2em_1fr]">
        ...
        <div className="grid grid-cols-[7fr_3fr]">
          <div className="bg-[#535961] flex flex-col justify-center items-center">
            <h1 className="text-white">
            sdfsfd
            </h1>
          </div>
          <div className="bg-[#535961]/50 flex flex-col justify-center items-center">
            <h1 className="text-white">
            sdfsfd
            </h1>
          </div>
