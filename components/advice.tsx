const advice = {
  faith: [
    ...
    "Strict adherence to one’s own free will, is the fall. Seeing it as a choice is a submission to your own will rather than of God's.",
  ...
  sloth: [
    ...
    "Each and every action are equally drastic, therefore no action is drastic. So you don't have to look something as hard to do.",
  ],
  fear: [
