...
export default function Label ({activeLink, title, desc, link}: LabelProps) {
  return (
    <div className={`z-850 absolute bottom-0 h-18 xl:h-24 pb-1 w-full flex flex-col items-center justify-center transition-all duration-400 ${activeLink === link ? "text-yellow-200 bg-[#17191a]/90 white-glow" : "text-white bg-[#17191a]/30"}`}>
